...
public interface ItfInventario {
	...
	Integer[] buscar(int tipo, String Modelo, Localizacion loc, String responsableDNI); // null si no hay; (null en campos sin filtro)
	
	// Funciones de colaboracion con gestion economica.
